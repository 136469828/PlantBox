...
@interface CultivateController ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation CultivateController
- (void)viewDidLoad {
    [super viewDidLoad];
