...
@interface CommentsController ()<UITextViewDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate>
{
...
+(instancetype)ViewController
{
    ...
    CommentsController * ctrl = [[CommentsController alloc] initWithNibName:@"RichText" bundle:nil];
...
- (void)createView {
    ...
    self.messageInputView.font = [UIFont systemFontOfSize:13];
    ...
    //字体颜色
    [self.messageInputView.textStorage addAttribute:NSForegroundColorAttributeName value:kUIColorFromRGB(0x0) range:wholeRange];
    
    //字体
    [self.messageInputView.textStorage addAttribute:NSFontAttributeName value:[UIFont systemFontOfSize:13] range:wholeRange];
